...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 "JetBrains Mono",ui-monospace,monospace;color:rgba(255,255,255,.55);width:240px;height:160px}' +
    ...
    '.empty:hover .sub u{color:#9fd9f5;text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #38bdf8;outline-offset:-2px;' +
    '  background:rgba(56,189,248,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(255,255,255,.2);' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:#38bdf8}' +
